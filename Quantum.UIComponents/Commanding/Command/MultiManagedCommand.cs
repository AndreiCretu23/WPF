...
namespace Quantum.Command
{
    ...
    ///                            and the getter delegate will be used to re-compute the commands. After that, the commands will be re-processed by the framework 
    ...
    ///                                After that, the commands will be re-processed by the framework depending on their individual metadata.
