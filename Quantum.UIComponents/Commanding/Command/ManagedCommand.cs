...
namespace Quantum.Command
{
    ...
    /// of the application depending on their metadata : <para></para>
    ...
    ///                     This metadata type does not support multiple instances in the metadata collection of a managed command.<para></para>
    ...
    ///                            instance of the application's container. Supported event types are types which extend CompositePresentationEvent. <para></para>
